  ...
  protected override void Up(MigrationBuilder migrationBuilder)
  {
    ...
    migrationBuilder.CreateTable(
        ...
        columns: table => new
        {
          ...
          IsTerminalState = table.Column<bool>(type: "bit", nullable: false),
          TenantId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
          IsDeleted = table.Column<bool>(type: "bit", nullable: false),
          DeletedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
          RowVersion = table.Column<byte[]>(type: "rowversion", rowVersion: true, nullable: false),
    ...
    migrationBuilder.CreateTable(
        ...
        columns: table => new
        {
          Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
          Name = table.Column<string>(type: "nvarchar(max)", nullable: false),
          DescriptionMarkdownTemplate = table.Column<string>(type: "nvarchar(max)", nullable: false),
        ...
        constraints: table =>
        {
          ...
          table.ForeignKey(
                    name: "FK_TicketTemplates_AspNetUsers_CreatorId",
                    column: x => x.CreatorId,
                    principalTable: "AspNetUsers",
                    principalColumn: "Id",
                    onDelete: ReferentialAction.Cascade);
          table.ForeignKey(
                    name: "FK_TicketTemplates_TicketPriorities_DefaultPriorityId",
    ...
    migrationBuilder.CreateTable(
        ...
        columns: table => new
        {
          Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
          Title = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
          DomainHash = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: false),
          Description = table.Column<string>(type: "nvarchar(max)", nullable: false),
          DescriptionMarkdown = table.Column<string>(type: "nvarchar(max)", nullable: false),
          Status = table.Column<string>(type: "nvarchar(max)", nullable: false),
          PriorityId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
          ChilliesDifficulty = table.Column<int>(type: "int", nullable: false),
          GeoIpTimestamp = table.Column<string>(type: "nvarchar(max)", nullable: false),
        ...
        constraints: table =>
        {
          ...
          table.ForeignKey(
                    ...
                    onDelete: ReferentialAction.Restrict);
          table.ForeignKey(
                    name: "FK_Tickets_WorkflowStates_WorkflowStateId",
    ...
    migrationBuilder.CreateTable(
        ...
        columns: table => new
        {
          ...
          AllowedRoleId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
          Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
          TenantId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
          IsDeleted = table.Column<bool>(type: "bit", nullable: false),
          DeletedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
        ...
        constraints: table =>
        {
          table.PrimaryKey("PK_WorkflowTransitions", x => new { x.FromStateId, x.ToStateId });
          table.ForeignKey(
                    name: "FK_WorkflowTransitions_AspNetRoles_AllowedRoleId",
    ...
    migrationBuilder.CreateTable(
        ...
        constraints: table =>
        {
          ...
          table.ForeignKey(
                    name: "FK_SubTickets_AspNetUsers_CreatorId",
                    column: x => x.CreatorId,
                    principalTable: "AspNetUsers",
                    principalColumn: "Id",
                    onDelete: ReferentialAction.Restrict);
          table.ForeignKey(
                    name: "FK_SubTickets_Tickets_TicketId",
                    column: x => x.TicketId,
                    principalTable: "Tickets",
                    principalColumn: "Id",
                    onDelete: ReferentialAction.Restrict);
    ...
    migrationBuilder.CreateTable(
        ...
        constraints: table =>
        {
          table.PrimaryKey("PK_TicketCustomValues", x => new { x.TicketId, x.FieldDefinitionId });
          table.ForeignKey(
                    name: "FK_TicketCustomValues_CustomFieldDefinitions_FieldDefinitionId",
    ...
    migrationBuilder.CreateTable(
        ...
        constraints: table =>
        {
          ...
          table.ForeignKey(
                    name: "FK_TicketHistories_AspNetUsers_ActorUserId",
    ...
    migrationBuilder.CreateTable(
        ...
        constraints: table =>
        {
          table.PrimaryKey("PK_TicketUpvotes", x => new { x.TicketId, x.UserId });
          table.ForeignKey(
                    name: "FK_TicketUpvotes_AspNetUsers_UserId",
                    column: x => x.UserId,
                    principalTable: "AspNetUsers",
                    principalColumn: "Id",
                    onDelete: ReferentialAction.Cascade);
          table.ForeignKey(
                    name: "FK_TicketUpvotes_Tickets_TicketId",
                    column: x => x.TicketId,
                    principalTable: "Tickets",
                    principalColumn: "Id",
                    onDelete: ReferentialAction.Cascade);
    ...
    migrationBuilder.CreateTable(
        ...
        columns: table => new
        {
          ...
          HoursLogged = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
    ...
    migrationBuilder.CreateTable(
        ...
        constraints: table =>
        {
          ...
          table.ForeignKey(
                    ...
                    onDelete: ReferentialAction.Cascade);
          table.ForeignKey(
                    name: "FK_FileAssets_Messages_MessageId",
                    column: x => x.MessageId,
                    principalTable: "Messages",
                    principalColumn: "Id",
                    onDelete: ReferentialAction.Cascade);
          table.ForeignKey(
                    name: "FK_FileAssets_Tickets_TicketId",
                    column: x => x.TicketId,
                    principalTable: "Tickets",
                    principalColumn: "Id",
                    onDelete: ReferentialAction.Cascade);
    ...
    migrationBuilder.CreateTable(
        ...
        constraints: table =>
        {
          ...
          table.ForeignKey(
                    ...
                    onDelete: ReferentialAction.Cascade);
          table.ForeignKey(
                    name: "FK_UserProfiles_FileAssets_AvatarImageId",
    ...
    migrationBuilder.InsertData(
        table: "AspNetRoles",
        columns: new[] { "Id", "ConcurrencyStamp", "DeletedAt", "Description", "IsDeleted", "Name", "NormalizedName", "TenantId" },
        values: new object[,]
        {
                  { new Guid("32d733e1-4c7a-4c2d-9b51-1e9a7e6b7d21"), "32d733e1-4c7a-4c2d-9b51-1e9a7e6b7d21", null, "Full system access", false, "Admin", "ADMIN", Guid.Empty },
                  { new Guid("b8f2e9d2-6c8a-4d3e-ac62-2f0b8f7c8e33"), "b8f2e9d2-6c8a-4d3e-ac62-2f0b8f7c8e33", null, "Team lead permissions", false, "Teamlead", "TEAMLEAD", Guid.Empty },
                  { new Guid("c903f0e3-7d9b-4e4f-bd73-3f1c908d9f44"), "c903f0e3-7d9b-4e4f-bd73-3f1c908d9f44", null, "Standard user access", false, "User", "USER", Guid.Empty },
        });

    migrationBuilder.InsertData(
        table: "TicketPriorities",
        columns: new[] { "Id", "ColorHex", "DeletedAt", "IsDeleted", "LevelWeight", "Name", "TenantId" },
        values: new object[,]
        {
                  { new Guid("034734c7-b03f-5283-f017-735034c13388"), "#FF0000", null, false, 4, "Blocker", Guid.Empty },
                  { new Guid("d01401f4-8e0c-4f50-ce84-402d019e0055"), "#808080", null, false, 1, "Low", Guid.Empty },
                  { new Guid("e12512a5-9f1d-5061-df95-513e12af1166"), "#0000FF", null, false, 2, "Medium", Guid.Empty },
                  { new Guid("f23623b6-af2e-5172-ef06-624f23b02277"), "#FFA500", null, false, 3, "High", Guid.Empty },
        });

    migrationBuilder.InsertData(
        table: "Workflows",
        columns: new[] { "Id", "DeletedAt", "IsDeleted", "Name", "TenantId" },
        values: new object[] { new Guid("145845d8-c140-5394-0128-846145d24499"), null, false, "Standard Workflow", Guid.Empty });

    migrationBuilder.InsertData(
        table: "WorkflowStates",
        columns: new[] { "Id", "ColorHex", "DeletedAt", "IsDeleted", "IsTerminalState", "Name", "OrderIndex", "TenantId", "WorkflowId" },
        values: new object[,]
        {
                  { new Guid("256956e9-d251-54a5-1239-957256e35500"), "#D3D3D3", null, false, false, "Todo", 0, Guid.Empty, new Guid("145845d8-c140-5394-0128-846145d24499") },
                  { new Guid("367a67fa-e362-55b6-234a-a68367f46611"), "#ADD8E6", null, false, false, "In Progress", 1, Guid.Empty, new Guid("145845d8-c140-5394-0128-846145d24499") },
                  { new Guid("478b780b-f473-56c7-345b-b79478057722"), "#FFFFE0", null, false, false, "In Review", 2, Guid.Empty, new Guid("145845d8-c140-5394-0128-846145d24499") },
                  { new Guid("589c891c-0584-57d8-456c-c8a589168833"), "#90EE90", null, false, true, "Done", 3, Guid.Empty, new Guid("145845d8-c140-5394-0128-846145d24499") },
        });
    ...
    migrationBuilder.CreateIndex(
        name: "IX_FileAssets_MessageId",
        table: "FileAssets",
        column: "MessageId");

    migrationBuilder.CreateIndex(
        name: "IX_FileAssets_TicketId",
        table: "FileAssets",
        column: "TicketId");
    ...
    migrationBuilder.CreateIndex(
        name: "IX_SubTickets_CreatorId",
        table: "SubTickets",
        column: "CreatorId");

    migrationBuilder.CreateIndex(
        name: "IX_SubTickets_TicketId",
        table: "SubTickets",
        column: "TicketId");
    ...
    migrationBuilder.CreateIndex(
        name: "IX_TicketCustomValues_FieldDefinitionId",
    ...
    migrationBuilder.CreateIndex(
        name: "IX_Tickets_WorkflowStateId",
        table: "Tickets",
    ...
    migrationBuilder.CreateIndex(
        name: "IX_TicketTemplates_CreatorId",
        table: "TicketTemplates",
        column: "CreatorId");

    migrationBuilder.CreateIndex(
        name: "IX_TicketTemplates_DefaultPriorityId",
        table: "TicketTemplates",
        column: "DefaultPriorityId");

    migrationBuilder.CreateIndex(
        name: "IX_TicketUpvotes_UserId",
        table: "TicketUpvotes",
        column: "UserId");
