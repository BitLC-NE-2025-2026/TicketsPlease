...
public interface IOrganizationService
{
  ...
  public Task<OrganizationDto?> GetOrganizationByIdAsync(Guid id, CancellationToken ct = default);
  ...
  public Task<OrganizationDto> CreateOrganizationAsync(UpsertOrganizationDto dto, CancellationToken ct = default);
  ...
  public Task UpdateOrganizationAsync(Guid id, UpsertOrganizationDto dto, CancellationToken ct = default);
  ...
  public Task<OrganizationInviteDto?> ValidateInviteTokenAsync(Guid token);
  ...
  /// <returns>Task.</returns>
  public Task MarkInviteAsUsedAsync(Guid token, Guid userId);
  ...
  public Task<List<AuditLogDto>> GetAuditLogsAsync(Guid organizationId, CancellationToken ct = default);
}
