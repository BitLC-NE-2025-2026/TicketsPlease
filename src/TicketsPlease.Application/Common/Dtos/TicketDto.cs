...
/// <summary>
/// DatenÃ¼bertragungsobjekt fÃ¼r ein Ticket (F3).
/// </summary>
...
/// <param name="ProjectId">Die ID des zugehÃ¶rigen Projekts.</param>
/// <param name="ProjectTitle">Der Name des Projekts (fÃ¼r die UI).</param>
...
/// <param name="Priority">Die PrioritÃ¤tsdetails.</param>
/// <param name="CreatedAt">Der Erstellungszeitpunkt.</param>
/// <param name="EstimatePoints">Die geschÃ¤tzten Story Points.</param>
...
/// <param name="SubTickets">ZugehÃ¶rige Unteraufgaben.</param>
...
/// <param name="Attachments">Zugeordnete DateianhÃ¤nge.</param>
/// <param name="History">Ã„nderungsjournal des Tickets.</param>
...
/// <param name="ResponseDeadline">Die Antwortfrist fÃ¼r das Ticket.</param>
/// <param name="ResolutionDeadline">Die LÃ¶sungsfrist fÃ¼r das Ticket.</param>
