# ADR 0012: Resilience & Fault Handling (Polly)
* Status: accepted
* Deciders: Tobias
* Date: 2026-03-06

## Context and Problem Statement
Verteilte Systeme (Datenbank, Mail-Server, externe Plugins) können temporär ausfallen. Ohne eine Strategie zum Umgang mit Fehlern (Transiente Fehler) stürzt die Applikation bei kleinen Netzwerkstörungen sofort ab.
...
## Decision Outcome
Chosen option: "Polly", because es ein bewährtes .NET Framework ist, um Politiken wie "Retry", "Circuit Breaker", "Timeout" oder "Fallback" deklarativ zu definieren.
